...
const FeedbackResponsesPage = () => {
  ...
  const fetchSummary = useCallback(async (isRefresh = false) => {
    try {
      ...
      const response = await trainingPrincipalService.getFeedbackResponseSummary();
  ...
  const fetchTrainingDetails = useCallback(async (trainingId) => {
    ...
    try {
      ...
      const response = await trainingPrincipalService.getTrainingFeedbackResponses(trainingId);
