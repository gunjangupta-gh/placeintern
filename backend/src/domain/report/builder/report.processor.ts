...
export class ReportProcessor extends WorkerHost {
  ...
  private getExportConfig(
    ...
    const reportColumns: Record<string, any[]> = {
      ...
      'training_feedback_analysis': [
        { field: 'trainingTitle', header: 'Training', type: 'string' as const, width: 30 },
        { field: 'trainingStartDate', header: 'Start Date', type: 'date' as const, width: 14 },
        { field: 'trainingEndDate', header: 'End Date', type: 'date' as const, width: 14 },
        { field: 'totalParticipants', header: 'Total Participants', type: 'number' as const, width: 16 },
        { field: 'totalFeedbackResponses', header: 'Feedback Responses', type: 'number' as const, width: 16 },
        { field: 'responseRate', header: 'Response Rate %', type: 'number' as const, width: 14 },
        { field: 'totalRatings', header: 'Total Ratings', type: 'number' as const, width: 12 },
        { field: 'rating5Count', header: 'Rating 5 (Count)', type: 'number' as const, width: 14 },
        { field: 'rating5Pct', header: 'Rating 5 (%)', type: 'number' as const, width: 12 },
        { field: 'rating4Count', header: 'Rating 4 (Count)', type: 'number' as const, width: 14 },
        { field: 'rating4Pct', header: 'Rating 4 (%)', type: 'number' as const, width: 12 },
        { field: 'rating3Count', header: 'Rating 3 (Count)', type: 'number' as const, width: 14 },
        { field: 'rating3Pct', header: 'Rating 3 (%)', type: 'number' as const, width: 12 },
        { field: 'rating2Count', header: 'Rating 2 (Count)', type: 'number' as const, width: 14 },
        { field: 'rating2Pct', header: 'Rating 2 (%)', type: 'number' as const, width: 12 },
        { field: 'rating1Count', header: 'Rating 1 (Count)', type: 'number' as const, width: 14 },
        { field: 'rating1Pct', header: 'Rating 1 (%)', type: 'number' as const, width: 12 },
        { field: 'highestRatedQuestion', header: 'Highest Rated Question', type: 'string' as const, width: 40 },
        { field: 'highestRatedAvg', header: 'Highest Rating Avg', type: 'number' as const, width: 16 },
        { field: 'lowestRatedQuestion', header: 'Lowest Rated Question', type: 'string' as const, width: 40 },
        { field: 'lowestRatedAvg', header: 'Lowest Rating Avg', type: 'number' as const, width: 16 },
        { field: 'avgOverallSatisfaction', header: 'Avg Rating Q1', type: 'number' as const, width: 14 },
        { field: 'avgContentQuality', header: 'Avg Rating Q2', type: 'number' as const, width: 14 },
        { field: 'avgTrainerKnowledge', header: 'Avg Rating Q3', type: 'number' as const, width: 14 },
        { field: 'avgTrainerCommunication', header: 'Avg Rating Q4', type: 'number' as const, width: 14 },
        { field: 'avgMaterialsQuality', header: 'Avg Rating Q5', type: 'number' as const, width: 14 },
        { field: 'avgPracticalRelevance', header: 'Avg Rating Q6', type: 'number' as const, width: 14 },
        { field: 'avgTimeManagement', header: 'Avg Rating Q7', type: 'number' as const, width: 14 },
        { field: 'avgRecommendTraining', header: 'Avg Rating Q8', type: 'number' as const, width: 14 },
        { field: 'expectationFullyMet', header: 'Expectations Fully Met', type: 'number' as const, width: 18 },
        { field: 'expectationPartiallyMet', header: 'Expectations Partially Met', type: 'number' as const, width: 20 },
