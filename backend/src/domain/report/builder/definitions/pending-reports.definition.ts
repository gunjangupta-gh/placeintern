...
export const pendingReportDefinitions: Record<string, ReportDefinition> = {
  'pending-monthly-visits': {
    ...
    columns: [
      ...
      { id: 'pendingMonth', label: 'Report Month', type: 'string', default: true, sortable: true },
      { id: 'pendingYear', label: 'Year', type: 'number', default: true, sortable: true },
    ...
    groupBy: ['institutionName', 'mentorName', 'urgency', 'pendingMonth'],
    sortableColumns: ['mentorName', 'daysSinceLastVisit', 'visitsDue', 'pendingMonth'],
