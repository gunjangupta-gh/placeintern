...
@ApiTags('Principal - Training Recommendations')
@ApiBearerAuth()
@Controller('principal/training/recommendations')
@UseGuards(JwtAuthGuard, RolesGuard)
@Roles(Role.PRINCIPAL)
export class PrincipalRecommendationController {
  constructor(private readonly recommendationService: TrainingRecommendationService) {}

  @Throttle({ default: THROTTLE_PRESETS.list })
  @Get()
  @ApiOperation({ summary: 'Get recommendations from faculty of my institution' })
